...
const FeaturedArticle = ({ img, title, time, summary, link }) => {
    return (
        <li className="col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-2xl relative dark:border-light dark:bg-dark">
            ...
            rounded-br-3xl dark:border-light dark:bg-dark" />
...
const articles = () => {
    return (
        <>
            <Head>
                <title>Supinder Singh | Articles Page</title>
                <meta name="description" content="Full stack developer bio" />
            </Head>
            <TransitionEffect />
            <main className="w-full mb-16 flex flex-col items-center justify-between overflow-hidden dark:text-light">
